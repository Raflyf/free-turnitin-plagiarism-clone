...
def generate_report_pdf(original_pdf_path, output_pdf_path, data):
    ...
    if ext != '.pdf':
        doc = fitz.open()
        page = doc.new_page()
        page.insert_text((50, 50), "Pemberitahuan:", fontsize=16, fontname="helv", color=(1,0,0))
        page.insert_text((50, 80), "Dokumen yang diunggah berformat Word (.docx / .doc).", fontsize=12, fontname="helv")
        page.insert_text((50, 100), "Fitur highlight warna pada teks dokumen asli saat ini hanya", fontsize=12, fontname="helv")
        page.insert_text((50, 120), "mendukung format PDF.", fontsize=12, fontname="helv")
        page.insert_text((50, 160), "Namun, hasil persentase plagiasi dan daftar sumber (Laporan", fontsize=12, fontname="helv")
        page.insert_text((50, 180), "Originalitas) di halaman berikutnya tetap dihitung 100% akurat.", fontsize=12, fontname="helv")
        page.insert_text((50, 220), "Silakan gulir ke halaman berikutnya untuk melihat hasilnya.", fontsize=12, fontname="helv", color=(0.4, 0.4, 0.4))
    else:
